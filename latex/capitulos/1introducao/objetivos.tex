...
Gana, focada exclusivamente no bairo de Nima, na capital, e tratará resumidamente 
...
\begin{itemize}
  ...
  \item Aperfeiçoar a metodologia numérica empregada na quantificação de 
        elementos químicos, buscando particularmente mais precisão e a determinação
  ...
  \item Apresentar uma proposta de calibração do equipamento de fluorescência 
        de raios X por dispersão em energia para melhorar a qualidade das medidas;
  ...
  \item Discussão dos resultados quantitativos face aos aspectos da realidade 
        ...
        ar no país, através de medidas viáveis.
  \end{spacing}
\end{itemize}
