...
formação de nuvens ou a saúde humana, causando doenças respiratórias, 
...
A seguir, estão resumidas, as características de cada moda do MP.
\begin{itemize}
\begin{spacing}{1.0}
...
constituído de carbono não orgânico absorvedores de luz visível e é 
...
A OMS realizou uma publicação que traz extensa revisão 
