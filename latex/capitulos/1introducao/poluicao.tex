...
(primária ou secundária) ou remoção da atmosfera, 
composição química forma geométrica da partículas \citep{seinfeld1998}.
...
Na moda fina $MP_{2,5}$ encontra-se principalmente íons $SO_4^=$, 
íons $ NO_3^-$, carbono elementar, carbono orgânico, 
elementos traços como metais (cádmio, níquel, vanádio, zinco, cromo, ferro, mercúrio), 
...
como poeira de solo, fuligem, pólens, metais alcalinos, entre outros. 
