...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.5\textwidth]{../outputs/windFrequencySpring.pdf}
  \includegraphics[width=0.5\textwidth]{../outputs/windFrequencySummer.pdf}
  \includegraphics[width=0.5\textwidth]{../outputs/windFrequencyFall.pdf}
  \includegraphics[width=0.5\textwidth]{../outputs/windFrequencyWinter.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.5\textwidth]{../outputs/windFrequencyHarmatao.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.5\textwidth]{../outputs/windRoseHarmatao.pdf}
  \caption{Rosa dos ventos}
\end{center}
\end{figure}
