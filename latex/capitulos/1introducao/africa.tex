...
Gana situa-se no continente Africano, na SSA, de 5 à 10 graus no hemisfério norte 
e faz fronteira com Costa do Marfim a oeste, ao norte com Burkina
...
sobre o continente Africano (longitudes -20E à 60E graus e latitudes de -30N à 40N 
...
República do Níger, Gana, entre outros, influencia o clima e a poluição do ar 
na região.
...
anual de Gana em 2010 foi de \$ 1,3 mi USD (United States Dollar) e no Brasil \$ 12 mi USD. 
...
o Driver and Vehicle Licensing Authority (DVLA), registrou em 2009 cerca de 1,13
...
Além dos veículos legalizados, Gana opera com veículos velhos e 
mal conservados, muitas dos quais não registradas pelo Governo, trazendo 
...
Segundo a Ghana Environmental Protection Agency (EPA-GH)	 
as principais fontes poluidoras do ar de Acra são:

\newpage
\begin{itemize}
	\begin{spacing}{1.0}
  \item Emissões veiculares, em especial das unidades antigas e sem manutenção
        frequente;
