...
em cidades da Ásia, África e Oriente Médio \cite{brauer2012}.   
...
diferentes das cidades dos países desenvolvidos \cite{brauer2012}.
...
Até 2003, nenhuma cidade da \textit{SSA} possuia sistemas de monitoramento 
...
Destaca-se características regionais da \textit{SSA} que ampliam as diferenças 
...
poeira do \textit{Deserto do Saara} \cite{breuning2005}.

O \textit{United States Department of Commerce National Oceanic 
...
impercepitível esse aumento. \cite{breuning2005} mostra que na 
...
de 2000 \cite{ghanacensus2003} e 2010 \cite{ghanacensus2013}. Os
dados resultantes podem ser encontrados no portal de dados abertos
do Governo Federal de Gana \cite{opendataghana}.
...
\begin{center}
  ...
  \caption{Pirâmide etária Gana plotada com dados do censo 
           demográfico de 2010 \cite{ghanacensus2013} \label{fig:piramedegana}}
\end{center}
\end{figure}
...
e serviços $51\%$ \cite{ghanacensus2013}.
...
hidrocarbonetos e minerais \cite{ghanacensus2013}.
...
variam de 0 até 60 metros do nível do mar \cite{ARKU2008}.
...
e em serviços, $90,5\%$ da polulação ocupando o meio urbano \cite{ghanacensus2013}.
...
dessas fazendas \cite{lente2014}, pois os resíduos das residências são despejados 
...
\begin{table}[H]
 \centering
  ...
  \caption{Frota veícular de Gana \cite{dvla} \label{table:dvla}}
\end{table}

Segundo a EPA de Gana \cite{epagh} as fontes de poluição do ar ambiental 
