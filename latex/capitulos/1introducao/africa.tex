...
\citet{breuning2005} e através do Harmatão influência o clima e a poluição do ar 
local dos países por onde passa, caso de Gana. Análises de modelos receptores 
realizadas tanto neste trabalho quanto em \citet{aboh2009}, \citet{dionisio2010b}, 
\citet{zhou2011} e \citet{rooney2012} mostram que ele representa a principal 
fonte de partículas tanto na fração fina $MP_{2,5}$ quanto na grossa 
$MP_{2,5-10}$ de Gana.
...
automóveis e navios. Em termos de matéria primária, há significativa exportação de 
