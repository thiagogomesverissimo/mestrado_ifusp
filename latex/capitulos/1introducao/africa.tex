%%%%
\section{África Subsariana 2}

%Todas estas bibliografias citadas precisam de ser reavaliadas, mesmo que permaneçam porque são de bons autores. Elas têm entre 6 a 11 anos. Não me parece que a situação da África tenha mudado neste período. Mas é necessário incluir avaliações mais atualizadas sobre as afirmações que trazem - inicie pela UN/WHO, buscando a África, e siga pelos canais específicos para tanto: Web of Science/ Google Science etc. Precisa de um cuidado especial para a citação do Majid, que é de 2004 e verificar se efetivamente a situação é a mesma. Veja que depois destes trabalhos no mínimo foram acrescidos aqueles resultantes deste projeto e eles têm que estar nesta revisão. Portanto, precisa de uma redação que não seja troncha e os incorpore, indicando que, se mais não há, no mínimo eles foram os seguintes após esta avaliação que, se não me engano foi o Majid que fez.
...
de alimentos, tanto em regiões urbanas quanto rurais \citep{SMITH2004}. Outras características regionais ampliam as diferenças na qualidade do ar e no perfil de fontes observado:%Veja que os itens abaixo não dizem respeito apenas às fontes de poluiçãodo ar por isso eu incluí a referência à qualidade do ar também. Este parágrafo ainda estava repetitivo em relação ao anterior
  \begin{itemize}
...
total de mais de 2500 $km^2$ com elevações que variam de 0 até 100 pés %atenção para a unidade - use SI
do nível 
do mar. 
A população da região metropolitana de Acra estava em torno de 2 milhões em 2005, 
último censo disponível.%acho que caberia ampliar as informações sobre Acra: 1) o que há sobre a frota veicular?; 2) quais são as atividades econômicas locais? 3) qual o PIB da cidade e de Ghana? 4) qual o PIB per capita?
...
\end{figure}
% acho que essas fotos são de Nima e de uma zona rural. É importante ter um mapa que localize Ghana, destaque Acra e neste último destaque Nima. Quais as características deste bairro? Qual o contraste com os demais?
