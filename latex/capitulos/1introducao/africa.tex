...
\begin{figure}[H]
\begin{center}
  \includegraphics[scale=0.4]{../outputs/PIBGhanaBrazil.pdf}
  \caption{Pirâmide etária Gana. Dados de \cite{censu2013} \label{fig:piramedegana}}
\end{center}
\end{figure}
...
% PIB: http://www.statsghana.gov.gh/gdp.html
...
% mais dados sobre economia de Ghana: https://en.wikipedia.org/wiki/Economy_of_Ghana
