...
elementos químicos e não exige pré-tratamento químico dos alvos.
...
correspondem às energias de transição entre camadas do átomos, 
...
As transições dos elétrons entre o nível quântico K, L e M encontram-se 
tipicamente na faixa dos raios X, tendendo a UV e luz visível conforme ocorram 
em transições atômicas de menor energia no átomo.
...
dos subníveis e trabalha-se com as denominações de linhas K e L apenas. 

As linha $K_{\alpha}$ são as mais intensas, oferecendo melhor limite de detecção
...
ser analisadas. No modelo de XRF usado, analisou-se as linhas K, desde o sódio 
(Na) até molibdênio (Mo), e as linha L, desde o molibdênio (Mo) até o chumbo 
(Pb).  
...
%TODO: Colocar área do detector, corrent
