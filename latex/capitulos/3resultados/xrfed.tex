...
Ressaltamos, ainda, que calibrações periódicas são necessãrias para atualizar os
...
A inter-comparação dos resultados das medidas das 92 amostras da XRF do LAPAt e 
...
%regressão simples porque não barra de erro, outro probelmas com ajuste, 
%padrões certificados, terceiro laboratório.
% Cl está na linha L do Ródio
% O Pb, com exceção de um outliewr, '1:1
