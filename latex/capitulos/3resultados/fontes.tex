...
Formação da brisa marinha (pois acra é costeira) ao 12:00 e virada ao longo 
...
\begin{table}[H]
  \centering
  \input{../outputs/beautifulFAdisplay_RFeH4.tex}
...
\begin{table}[H]
  \centering
  \input{../outputs/beautifulFAdisplay_TFeH4.tex}
...
\begin{table}[H]
  \centering
  \input{../outputs/beautifulFAdisplay_RGeH5.tex}
  \caption{Análise de Fatores na área residencial para $MP_{2,5-10}$
           somente dos dias de ocorrência de vento Harmatão. n = 49.
          \label{table:AF_RFsH5}}
\end{table}
...
\begin{table}[H]
  \centering
  \input{../outputs/beautifulFAdisplay_TGeH5.tex}
  \caption{Análise de Fatores na avenida para $MP_{2,5-10}$
           somente dos dias de ocorrência de vento Harmatão. n = 58.
          \label{table:AF_TFsH5}}
\end{table}
...
\begin{landscape}
  \begin{figure}
    \centering
    \begin{minipage}[b]{0.45\linewidth}
      \includegraphics[width=\textwidth]{../outputs/RGeH_pmf_contribution_pizza5.pdf}
      \caption{Contribuição dos fatores na massa total para $MP_{2,5-10}$ na área
               residencial somente nos dias de ocorrência de vento Harmatão. seed = 123 n = 49.
               \label{fig:RIeH_contribution4}}
    \end{minipage}%\hfill
    \hspace{0.5cm}
    \begin{minipage}[b]{0.45\linewidth}
      \input{../outputs/RGeH_profiles_percent_species5.tex}
      \captionof{table}{Perfis do fatores para $MP_{2,5-10}$ na área residencial,
                 somente nos de ocorrência de vento Harmatão. seed=123 e n= 49. 
                \label{table:RIeH_profiles4}}
    \end{minipage}
...
\begin{landscape}
  \begin{figure}
    ...
    \begin{minipage}[b]{0.45\linewidth}
      ...
      \captionof{table}{Perfis do fatores na avenida $MP_{10-2,5}$ 
...
\begin{landscape}
  \begin{figure}
    \centering
    \begin{minipage}[b]{0.45\linewidth}
      \includegraphics[width=\textwidth]{../outputs/TGeH_pmf_contribution_pizza5.pdf}
      \caption{Contribuição dos fatores na massa total para $MP_{10-2,5}$ na avenida
               somente nos dias de ocorrência de vento Harmatão. seed = 123 n = 58.
               \label{fig:TIeH_contribution4}}
    \end{minipage}%\hfill
    \hspace{0.5cm}
    \begin{minipage}[b]{0.45\linewidth}
      \input{../outputs/TGeH_profiles_percent_species5.tex}
      \captionof{table}{Perfis do fatores na avenida $MP_{10-2,5}$ 
                 somente nos de ocorrência de vento Harmatão. seed=123 e n= 58. 
                \label{table:TIeH_profiles4}}
    \end{minipage}
...
\begin{landscape}
  \begin{figure}
    \centering
    \begin{minipage}[b]{0.45\linewidth}
      \includegraphics[width=\textwidth]{../outputs/RFeH_pmf_contribution_pizza4.pdf}
    ...
    \hspace{0.5cm}
    \begin{minipage}[b]{0.45\linewidth}
      \input{../outputs/RFeH_profiles_percent_species4.tex}
...
\begin{landscape}
  \begin{figure}
    \centering
    \begin{minipage}[b]{0.45\linewidth}
      \includegraphics[width=\textwidth]{../outputs/TFeH_pmf_contribution_pizza4.pdf}
