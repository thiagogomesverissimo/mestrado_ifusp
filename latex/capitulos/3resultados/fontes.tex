...
de partículas em mais de 400 \% para alguns dias do inverno, o que 
além de ofuscar fontes poluídoras antropogênicas locais, prejudicam 
...
Caso contrário o fator representante do Harmatão ofusca os fatores 
associados as fontes locais. 
...
englobando a maioria dos elementos que sozinho explicaria mais que 57,9 \% da 
variância (tabela \ref{table:AF_RFcH5} do apêndice \ref{apendice:pmf_fa}).
...
\begin{table}[H]
  \centering
  \input{../inputs/latex/fontes_fino.tex}
...
\begin{table}[H]
  \centering
  \input{../inputs/latex/fontes_grosso.tex}
  \caption{Síntese das associações dos fatores extraídos na AF e PMF com fontes 
