...
O grande número de amostras possibilitou separar as concentrações
com e sem harmatão.
Essa divisão não é completamente estrita, pois mesmo nos meses 
de ocorrência do Harmatão, o vento não é constante. 
Usamos um critério sugerido por \cite{aboh2009}, onde os dias de cocrreência 
do harmatão são os de concentrações de Si maiores que 10  ug/m3 dentro
dos meses de ocorreêcnia do mesmo.
