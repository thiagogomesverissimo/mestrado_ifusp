...
Foram coletadas 879 amostras (de 48 horas) entre novembro de 2006 e 
agosto de 2008 em dois locais distantes 250 metros entre si. 
Um na principal avenida do bairro e outro em uma rua residencial. 

A concentração anual média de $MP_{2,5}$ encontrada na avenida 
foi de 76,4 (9) $\mu g/m^3$ e 83,3 (18) $\mu g/m^3$ na área residencial, 
superando a diretrize de 10 $\mu g/m^3$ recomendada pela 
Organização Mundial de Saúde (OMS). 
Outra recomendação da OMS é que a concentração não ultrapasse 
25 $\mu g/m^3$ em mais que 1\% das amostras em um ano. A porcentagem de ultrapassagem foi de 66,5\% e 92\% para a área residencial e avenida, respectivamente. 

As concentrações químicas elementares foram obtidas por 
Fluorescência de raios X (XRF) e o Black Carbon (BC) por 
refletância, inter calibrada com Thermal Optical Transmitance (TOT). 
...
mostraram-se concordantes: Sal marinho (Na, Cl), solo (Fe, Ti, Mn, 
Si, Al, Ca, Mg), emissões veiculares (BC, Pb, Zn, K) e queima de 
biomassa (K, P, S, BC). 
