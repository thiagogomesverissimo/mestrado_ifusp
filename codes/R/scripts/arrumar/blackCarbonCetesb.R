...
############################ Filtros Cetesb 2012 - Testes
cetesb2012= read.csv('../../inputs/BlackCarbon/calibration/cetesb2012.csv')
x = log10(cetesb2012$refletencia)
y = cetesb2012$massa_ugcm2
y_erro = cetesb2012$erro_ugcm2
...
pdf('../../outputs/CalibracaoCetesb2012.pdf')
# Gráfico 'vazio'
mar.default <- c(5,4,4,2) + 0.5
par(mar = mar.default + c(0, 3, 0, 0))
plot(0,0,
...
axis(side=1, at=seq(0.4, 2, by=0.05))
axis(side=2, at=seq(0, 100, by=10))
