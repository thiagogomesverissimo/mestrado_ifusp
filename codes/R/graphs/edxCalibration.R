...
pdf('../../outputs/Knov2016Calibration.pdf')
# Gráfico 'vazio'
...
K_nov2016 = read.csv('../../inputs/edxCalibration/americo/K_nov2016medido.csv',dec=',')
x = K_nov2016$Z
y_error = K_nov2016$Uncert
y = K_nov2016$R
errbar( x, y, y + y_error, y - y_error,pch=20, add=TRUE)
...
pdf('../../outputs/Lnov2016Calibration.pdf')
...
L_nov2016 = read.csv('../../inputs/edxCalibration/americo/L_nov2016medido.csv',dec=',')
x = L_nov2016$Z
y_error = L_nov2016$Uncert
y = L_nov2016$R
errbar( x, y, y + y_error, y - y_error,pch=20, add=TRUE)
