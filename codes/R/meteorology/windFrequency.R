...
autumn2006<-list(begin=strptime('21-09-2006','%d-%m-%Y'),end=strptime('20-12-2006','%d-%m-%Y'),titulo='Outono 2006',filename='autumn2006')
winter2006_2007<-list(begin=strptime('21-12-2006','%d-%m-%Y'),end=strptime('20-03-2007','%d-%m-%Y'),titulo='Inverno 2006-2007',filename='winter2006_2007')
spring2007<-list(begin=strptime('21-03-2007','%d-%m-%Y'),end=strptime('20-06-2007','%d-%m-%Y'),titulo='Primavera 2007',filename='spring2007')
summer2007<-list(begin=strptime('21-06-2007','%d-%m-%Y'),end=strptime('20-09-2007','%d-%m-%Y'),titulo='Verão 2007',filename='summer2007')
